...
|---|---|---|---|
| Navy `#0B2D5B`, navy-soft `#294E78`, Soft Sun yellow `#F0C94A` | One calmer yellow consistently serves identity and yellow-button roles | `Color.kt`, `CommonComponents.kt` | Matched |

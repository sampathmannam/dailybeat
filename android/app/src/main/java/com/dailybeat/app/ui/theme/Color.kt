...
// Original Signal Yellow: DailyBeat's first high-visibility route and action colour.
...
val GoldNightContainer = Color(0xFF514600)
val GoldNightInk = Color(0xFFFFF4B8)

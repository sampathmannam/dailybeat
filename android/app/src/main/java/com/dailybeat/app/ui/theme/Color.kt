...
// Warm Butter: a calmer high-visibility route and action colour selected for DailyBeat.
val Gold = Color(0xFFEED77B)
val GoldSoft = Color(0xFFFFF3C4)
...
val GoldNightContainer = Color(0xFF4D421A)
val GoldNightInk = Color(0xFFFFF3C4)

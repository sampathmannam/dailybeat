...
// Soft Sun: calm enough for large action surfaces, still unmistakably DailyBeat at a glance.
val Gold = Color(0xFFF0C94A)
val GoldSoft = Color(0xFFFFF1C2)
...
// Carbon, rather than a navy wash: dark mode uses neutral depth and lets content and state colors
// carry meaning. The three distinct levels preserve Material tonal elevation without blue cards.
val NightCanvas = Color(0xFF090A0C)
val NightSurface = Color(0xFF121418)
val NightElevated = Color(0xFF1A1D23)
val NightInk = Color(0xFFF4F5F7)
val NightMuted = Color(0xFFB8BEC7)
val NightOutline = Color(0xFF767E89)
val GoldNightContainer = Color(0xFF4D3F08)
val GoldNightInk = Color(0xFFFFF3C7)

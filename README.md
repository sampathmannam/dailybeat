...
**v3.9.0** — A private whole-day activity record with an adaptive journey-ledger interface,
...
The signed v3.9.0 APK is published through GitHub Releases only after the build, live cloud-backup
